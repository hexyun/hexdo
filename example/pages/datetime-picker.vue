<template>
  <div class="page-datetime">
    ...
    <div class="page-datetime-wrapper">
      ...
      <mt-button @click="visible3 = true" size="large">点击弹出 Time Picker 设置年月日样式</mt-button>
      <mt-button @click="visible4 = true" size="large">自定义模板</mt-button>
      <mt-button @click="visible5 = true" size="large">设定初始值</mt-button>
    </div>
    <!--<mt-datetime-picker :visible.sync="visible" :value.sync="value1" @confirm="handleChange"></mt-datetime-picker>-->
    <!--<mt-datetime-picker :visible.sync="visible2" type="date" @confirm="handleChange"></mt-datetime-picker>-->
    <!--<mt-datetime-picker :visible.sync="visible3" type="datetime" @confirm="handleChange"></mt-datetime-picker>-->
      <mt-datetime-picker :visible.sync="visible3" type="datetime" format="y/m/d" @confirm="handleChange"></mt-datetime-picker>
